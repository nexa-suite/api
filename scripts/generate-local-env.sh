...
NEXA_DEV_TENANT_ADMIN_EMAIL=tenant.admin@icisa.pe
NEXA_DEV_TENANT_ADMIN_PASSWORD=$(random_password)
NEXA_DEV_COMPANY_OWNER_EMAIL=company.owner@icisa.pe
NEXA_DEV_COMPANY_OWNER_PASSWORD=$(random_password)
