...
The current release is `v0.6.0`. Catalog remains shared local reference data; tenant-specific assortment, pricing and stock remain future bounded-context work.
