...
The v0.18.0 release follows the published v0.17.1 migration baseline. No
historical v0.17.1 release-note file is present in this repository; the
v0.17.0 notes remain unchanged.
