...
5. La matriz autenticada local y remota ejercitó Tenant Owner, Company Owner, Sales, Warehouse, Logistics y Buyer con `FAIL-NEW: 0` en los seis perfiles (`WARN-NEW: 6–7`, `PASS: 110–111`) en Security/Load `31254245975`. El baseline remoto reportó `FAIL-NEW: 0`, `WARN-NEW: 7`, `PASS: 60` sobre 13 URLs. Trivy/SBOM remoto en Supply Chain `31254246008` no detectó vulnerabilidades, secretos ni misconfiguraciones en filesystem ni imagen. Esto es evidencia ASVS-L2 objetivo, no certificación ASVS.
