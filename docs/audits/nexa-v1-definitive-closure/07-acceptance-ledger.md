...
| 16 | Performance/observability | PARTIAL | reads HTTP medidos bajo objetivos, query budgets 1/10/50 PASS y traza `nexa-api` en Jaeger; falta matriz completa k6/Gatling de comandos |
