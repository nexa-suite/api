...
|---|---:|---:|---:|---:|---:|---:|---|
| `GET /api/v1/catalog-items?page=0&size=25` | 100 | 9.6 ms | 11.7 ms | 18.6 ms | 8.2 ms | 21.7 ms | simple read p95 < 300 ms |
| `GET /api/v1/receivables?page=0&size=25` | 100 | 7.6 ms | 9.7 ms | 13.2 ms | 6.4 ms | 31.9 ms | paginated search p95 < 500 ms |
