package com.nexa.api.tenantaccessgovernance.iam.architecture;
...
import com.nexa.api.tenantaccessgovernance.iam.application.port.out.OrganizationRegistrationPersistencePort;
...
import com.nexa.api.tenantaccessgovernance.iam.application.service.OrganizationRegistrationService;
import com.nexa.api.tenantaccessgovernance.iam.application.service.PasswordResetService;
...
class IamDddArchitectureTests {
    private static final JavaClasses CLASSES = new ClassFileImporter().importPackages("com.nexa.api.tenantaccessgovernance.iam");
    ...
    void applicationOrchestratorsReferenceDomainAggregates() {
        assertThat(PasswordResetService.class.getDeclaredFields()).anyMatch(field -> field.getType().equals(com.nexa.api.tenantaccessgovernance.iam.application.port.out.PasswordResetPersistencePort.class));
