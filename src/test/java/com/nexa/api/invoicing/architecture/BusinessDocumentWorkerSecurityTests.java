...
class BusinessDocumentWorkerSecurityTests {
    private static final Path SERVICE = Path.of("src/main/java/com/nexa/api/invoicing/infrastructure/persistence/BusinessDocumentService.java");
    ...
    private static final Path RESERVATION_WORKER = Path.of("src/main/java/com/nexa/api/warehouse/infrastructure/persistence/WarehouseReservationPersistenceAdapter.java");
    private static final Path EXPIRY_ENTRYPOINT = Path.of("src/main/java/com/nexa/api/warehouse/application/ExpireReservation.java");
