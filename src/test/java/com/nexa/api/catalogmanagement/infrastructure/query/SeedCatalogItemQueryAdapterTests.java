...
class SeedCatalogItemQueryAdapterTests {
	...
	void findsOnlyActiveCatalogDetails() {
		assertThat(adapter.findByCatalogItemId(new com.nexa.api.catalogmanagement.domain.model.catalogitem.CatalogItemId("CAT-0001")))
				.isPresent().get().extracting(detail -> detail.catalogItemId()).isEqualTo("CAT-0001");
		assertThat(adapter.findByCatalogItemId(new com.nexa.api.catalogmanagement.domain.model.catalogitem.CatalogItemId("CAT-9999")))
				.isEmpty();
	}
}
