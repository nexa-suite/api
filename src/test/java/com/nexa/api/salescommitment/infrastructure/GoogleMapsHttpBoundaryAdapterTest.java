...
class GoogleMapsHttpBoundaryAdapterTest {
    ...
    private static MapRoutingPort.MapRouteRequest request() {
        var warehouse = new com.nexa.api.salescommitment.domain.model.delivery.WarehouseSnapshot(
        ...
        var address = new com.nexa.api.salescommitment.domain.model.delivery.DeliveryAddressSnapshot(
                "address", "Pueblo Libre",
                new com.nexa.api.customerbuyerrelationships.contract.Address(
