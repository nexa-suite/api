...
public final class ChangeEventAudiences {
	...
	private static final Map<String, Set<ChangeEventAudience>> INTERNAL = Map.ofEntries(
			...
			Map.entry("organization.membership.revoked", EnumSet.of(ChangeEventAudience.OWNER)),
			...
			Map.entry("sales.purchase-request.material-change-proposed", EnumSet.of(ChangeEventAudience.SALES)),
			Map.entry("sales.purchase-request.material-change-accepted", EnumSet.of(ChangeEventAudience.SALES)),
			Map.entry("sales.purchase-request.material-change-rejected", EnumSet.of(ChangeEventAudience.SALES)),
			...
			Map.entry("sales.purchase-request.withdrawn", EnumSet.of(ChangeEventAudience.SALES)),
			...
			Map.entry("warehouse.lot.temperature-hold", EnumSet.of(ChangeEventAudience.WAREHOUSE)),
			...
			Map.entry("warehouse.lot.disposition-recorded", EnumSet.of(ChangeEventAudience.WAREHOUSE)),
			Map.entry("warehouse.safety-stock.configured", EnumSet.of(ChangeEventAudience.WAREHOUSE)),
			Map.entry("warehouse.safety-stock.updated", EnumSet.of(ChangeEventAudience.WAREHOUSE)),
			Map.entry("warehouse.inventory.transfer.requested", EnumSet.of(ChangeEventAudience.WAREHOUSE)),
			Map.entry("warehouse.inventory.transfer.dispatched", EnumSet.of(ChangeEventAudience.WAREHOUSE)),
			Map.entry("warehouse.inventory.transfer.received", EnumSet.of(ChangeEventAudience.WAREHOUSE)),
			Map.entry("warehouse.inventory.transfer.completed", EnumSet.of(ChangeEventAudience.WAREHOUSE)),
			...
			Map.entry("logistics.delivery.attempt-failed", EnumSet.of(ChangeEventAudience.LOGISTICS, ChangeEventAudience.SALES)),
			Map.entry("logistics.delivery.partially-completed", EnumSet.of(ChangeEventAudience.LOGISTICS, ChangeEventAudience.SALES)),
			Map.entry("logistics.delivery.continuation-created", EnumSet.of(ChangeEventAudience.LOGISTICS, ChangeEventAudience.SALES)),
