...
public final class ClientAccount {
	...
	private ClientAccount(ClientAccountId id, ClientCode code, TaxIdentifier taxIdentifier, BusinessName businessName,
	...
	public static ClientAccount create(ClientAccountId id, ClientCode code, TaxIdentifier taxIdentifier, BusinessName businessName,
			CommercialName commercialName, ContactEmail contactEmail, PhoneNumber phoneNumber, PaymentCondition paymentCondition) {
