...
public interface LogisticsPersistencePort {
    ...
    LogisticsOperationsService.DispatchView startRoute(String tenantId, String workspaceId, String dispatchId, long version, String actorMembershipId, String key, long now);
