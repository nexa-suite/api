...
public class WarehouseSafetyStockPersistenceAdapter extends WarehouseJdbcSupport
    ...
    private void requireRead(CurrentAccessContext context) {
        context.requirePermission(com.nexa.api.tenantmanagement.domain.model.access.Permission.WAREHOUSE_READ);
    }

    private void requireWrite(CurrentAccessContext context) {
        context.requirePermission(com.nexa.api.tenantmanagement.domain.model.access.Permission.WAREHOUSE_WRITE);
    }
