...
public interface WarehouseOperationsPort {
    ...
    WarehouseOperationsService.OperationalProfile updateOperationalProfile(CurrentAccessContext context, String id,
                                                                             WarehouseOperationsService.OperationalPatch patch,
                                                                             long expected);
