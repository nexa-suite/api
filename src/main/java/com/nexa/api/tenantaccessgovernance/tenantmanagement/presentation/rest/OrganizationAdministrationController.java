...
public class OrganizationAdministrationController {
	...
	public ResponseEntity<OrganizationResponse> organization(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context) {
	...
	public List<WorkspaceSummary> workspaces(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context) { return administration.workspaces(context); }

	@PostMapping("/workspaces")
	public ResponseEntity<WorkspaceSummary> createWorkspace(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context,
	...
	public ResponseEntity<WorkspaceDetails> workspace(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context,@PathVariable String workspaceId) { var details=administration.workspace(context,workspaceId); return ResponseEntity.ok().eTag(etag(details.workspace().version())).body(details); }

	@PatchMapping("/workspaces/{workspaceId}")
	public ResponseEntity<WorkspaceSummary> updateWorkspace(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context,@PathVariable String workspaceId,@RequestHeader(name="If-Match",required=false) String ifMatch,@RequestBody WorkspacePatch patch,HttpServletRequest request) { var result=administration.updateWorkspace(context,workspaceId,patch.name(),patch.slug(),patch.status()==null?null:WorkspaceStatus.from(patch.status()),version(ifMatch),correlation(request)); return ResponseEntity.ok().eTag(etag(result.value().version())).body(result.value()); }

	@PostMapping("/workspaces/{workspaceId}/suspensions")
	public ResponseEntity<WorkspaceSummary> suspendWorkspace(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context,@PathVariable String workspaceId,@RequestHeader(name="If-Match",required=false) String ifMatch,HttpServletRequest request) { var result=administration.suspendWorkspace(context,workspaceId,version(ifMatch),correlation(request)); return ResponseEntity.ok().eTag(etag(result.value().version())).body(result.value()); }

	@PostMapping("/workspaces/{workspaceId}/reactivations")
	public ResponseEntity<WorkspaceSummary> reactivateWorkspace(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context,@PathVariable String workspaceId,@RequestHeader(name="If-Match",required=false) String ifMatch,HttpServletRequest request) { var result=administration.reactivateWorkspace(context,workspaceId,version(ifMatch),correlation(request)); return ResponseEntity.ok().eTag(etag(result.value().version())).body(result.value()); }

	@GetMapping("/workspace-memberships")
	public List<WorkspaceMembershipSummary> memberships(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context) { return administration.memberships(context); }

	@GetMapping("/workspace-memberships/{membershipId}")
	public ResponseEntity<WorkspaceMembershipSummary> membership(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context,@PathVariable String membershipId) { var value=administration.membership(context,membershipId); return ResponseEntity.ok().eTag(etag(value.version())).body(value); }

	@PatchMapping("/workspace-memberships/{membershipId}/roles")
	public ResponseEntity<WorkspaceMembershipSummary> roles(@RequestAttribute("com.nexa.api.tenantaccessgovernance.tenantmanagement.application.model.CurrentAccessContext") CurrentAccessContext context,
