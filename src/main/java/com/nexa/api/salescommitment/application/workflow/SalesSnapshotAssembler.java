package com.nexa.api.salescommitment.application.workflow;
...
public final class SalesSnapshotAssembler {
    ...
    private final com.nexa.api.salescommitment.application.purchaserequest.port.CatalogItemSnapshotLookupPort catalog;
    private final com.nexa.api.salescommitment.application.purchaserequest.port.SellableSkuSnapshotLookupPort sellableSkus;
    ...
    public SalesSnapshotAssembler(ClientAccountCommercialPort commercial, CustomerAddressQuery addresses,
                                  ...
                                  MapRoutingPort maps,
                                  com.nexa.api.salescommitment.application.purchaserequest.port.CatalogItemSnapshotLookupPort catalog) {
    ...
    public BuyerAssembly buyer(CurrentAccessContext context, String clientAccountId, String addressId,
        ...
        return new BuyerAssembly(lines, new com.nexa.api.salescommitment.domain.model.buyerrequest.BuyerRequestSnapshot(
    ...
    public ManualAssembly manual(CurrentAccessContext context, String clientAccountId, String addressId,
        ...
        return new ManualAssembly(lines, priority, new com.nexa.api.salescommitment.domain.model.salesorder.ManualSalesOrderSnapshot(
    ...
    private BaseAssembly base(CurrentAccessContext context, String accountId, String addressId, Address manualAddress,
        ...
        ClientAccountCommercialPort.ClientAccountCommercialProfile profile = commercial.find(scope(context), workspace(context), accountId)
                .orElseThrow(() -> new com.nexa.api.salescommitment.application.exception.SalesResourceNotFoundException("client-account"));
        ...
        WarehouseReferencePort.WarehouseReference warehouse = warehouseId == null || warehouseId.isBlank()
                ...
                .orElseThrow(() -> new com.nexa.api.salescommitment.application.exception.SalesResourceNotFoundException("warehouse"))
    ...
    private List<PurchaseRequestLine> buyerLines(List<com.nexa.api.salescommitment.application.buyerrequest.model.CreateBuyerRequestCommand.Line> requested,
        ...
        for (var line : safeLines) {
            ...
            if (item == null) throw new com.nexa.api.salescommitment.application.exception.SalesResourceNotFoundException("catalog-item");
    ...
    private List<com.nexa.api.salescommitment.domain.model.salesorder.SalesOrderLine> manualLines(
        ...
        for (var line : safeLines) {
            ...
            if (line.skuId() != null) {
                ...
                if (sku == null) throw new com.nexa.api.salescommitment.application.exception.SalesResourceNotFoundException("sellable-sku");
                ...
                result.add(new com.nexa.api.salescommitment.domain.model.salesorder.SalesOrderLine(legacyId, sku.familyName(), sku.presentation(), quantity,
                ...
                result.add(new com.nexa.api.salescommitment.domain.model.salesorder.SalesOrderLine(item.catalogItemId(), item.itemName(),
    ...
    private String resolveAccountIdForBuyer(CurrentAccessContext context, String requested) {
        ...
        if (requested != null && !requested.isBlank() && !account.equals(requested.trim())) {
            throw new com.nexa.api.salescommitment.application.exception.SalesResourceNotFoundException("client-account");
        }
        return account;
    }
    ...
    public record BuyerAssembly(List<PurchaseRequestLine> lines,
                                com.nexa.api.salescommitment.domain.model.buyerrequest.BuyerRequestSnapshot snapshot) {
        public BuyerAssembly { lines = List.copyOf(lines); }
    }

    public record ManualAssembly(List<com.nexa.api.salescommitment.domain.model.salesorder.SalesOrderLine> lines,
                                 com.nexa.api.salescommitment.domain.model.purchaserequest.PurchaseRequestPriority priority,
                                 com.nexa.api.salescommitment.domain.model.salesorder.ManualSalesOrderSnapshot snapshot) {
