package com.nexa.api.salescommitment.presentation.directorder;
...
public final class DirectOrderController {
    ...
    public ResponseEntity<SalesOrderResponse> create(
        ...
        var value = directOrders.create(context, request.clientAccountId(), request.priority(), request.requestedDeliveryDate(),
                ...
                (request.lines() == null ? java.util.List.<com.nexa.api.salescommitment.presentation.purchaserequest.request.PurchaseRequestLineRequest>of() : request.lines()).stream()
