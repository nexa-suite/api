...
import com.nexa.api.fulfillmentdelivery.domain.dispatchorder.ClientAccountId;
import com.nexa.api.fulfillmentdelivery.domain.dispatchorder.DeliveryWindow;
import com.nexa.api.fulfillmentdelivery.domain.dispatchorder.DestinationSnapshot;
import com.nexa.api.fulfillmentdelivery.domain.dispatchorder.DispatchNumber;
...
abstract class DispatchJdbcSupport {
    ...
    protected static LogisticsOperationsService.HandoffNoteView valueView(
            com.nexa.api.fulfillmentdelivery.domain.handoff.OperationalHandoffNote value) {
