...
public final class OrderSummaryCsvRenderer implements BusinessDocumentRenderer {
    ...
    @Override public RenderedDocument render(DocumentProjection projection, BusinessDocumentFormat format) {
        RendererSupport.require(projection, com.nexa.api.invoicing.application.model.BusinessDocumentProjections.OrderSummaryProjection.class, BusinessDocumentType.ORDER_SUMMARY, BusinessDocumentFormat.CSV);
