...
public final class DedicatedDocumentRenderer implements DocumentRendererPort {
    ...
    private record TypeOnlyProjection(BusinessDocumentType type) implements DocumentProjection {
        ...
        @Override public com.nexa.api.invoicing.application.model.BusinessDocumentProjections.BusinessParty issuer() { return null; }
        @Override public com.nexa.api.invoicing.application.model.BusinessDocumentProjections.BusinessParty buyer() { return null; }
        @Override public java.util.List<com.nexa.api.invoicing.application.model.BusinessDocumentProjections.DocumentLine> lines() { return java.util.List.of(); }
        @Override public com.nexa.api.invoicing.application.model.BusinessDocumentProjections.DocumentTotals totals() { return null; }
        @Override public com.nexa.api.invoicing.application.model.BusinessDocumentProjections.DeliveryInfo delivery() { return null; }
