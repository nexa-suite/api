...
import com.nexa.api.catalogmanagement.domain.model.brand.Brand;
import com.nexa.api.catalogmanagement.domain.model.brand.BrandId;
import com.nexa.api.catalogmanagement.domain.model.brand.BrandStatus;
import com.nexa.api.catalogmanagement.domain.model.category.Category;
import com.nexa.api.catalogmanagement.domain.model.category.CategoryId;
...
public final class CatalogTaxonomyService implements CatalogTaxonomyUseCase {
    ...
    @Override public CatalogManagementModels.CategoryView updateCategory(CatalogScope scope, UUID id, UUID parentId, String slug, String name, String description, long version) {
        authorization.require(CatalogPermissions.MANAGE);
        CatalogManagementModels.CategoryView current = port.category(scope, id).orElseThrow(() -> new com.nexa.api.catalogmanagement.application.exception.CatalogResourceNotFoundException("category"));
        if (port.categoryWouldCreateCycle(scope, id, parentId)) throw new com.nexa.api.catalogmanagement.application.exception.CatalogConflictException("CATALOG_CATEGORY_CYCLE");
    ...
    @Override public CatalogManagementModels.BrandView updateBrand(CatalogScope scope, UUID id, String slug, String name, String description, long version) {
        authorization.require(CatalogPermissions.MANAGE);
        CatalogManagementModels.BrandView current = port.brand(scope, id).orElseThrow(() -> new com.nexa.api.catalogmanagement.application.exception.CatalogResourceNotFoundException("brand"));
