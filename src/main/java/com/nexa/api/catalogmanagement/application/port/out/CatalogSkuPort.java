...
public interface CatalogSkuPort {
    ...
    CatalogSkuModels.FamilyView createFamily(CatalogScope scope, String code, String name, String description, UUID categoryId, UUID brandId, String country, String manufacturer, String supplier, String storageFamily);
    ...
    CatalogSkuModels.SkuView createSku(CatalogScope scope, UUID familyId, String skuCode, String gtin, String presentation, String packaging, String unit, BigDecimal netWeight, BigDecimal grossWeight, BigDecimal packQuantity, BigDecimal temperatureMin, BigDecimal temperatureMax, int shelfLifeDays, int minimumRemainingShelfLifeDays, boolean lotTracking, boolean expiryTracking, String taxCategory);
    CatalogSkuModels.SkuView changeSkuStatus(CatalogScope scope, UUID id, String status, long expectedVersion);
    CatalogSkuModels.PriceView createPrice(CatalogScope scope, UUID skuId, BigDecimal amount, String currency, Instant validFrom, Instant validUntil, String sourceCode, String sourceDescription);
